...
func addMessage(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodPost {
		...
		fmt.Fprintln(w, "Ошибка: метод не разрешен. Используйте POST для добавления сообщения")
...
func deleteMessage(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodDelete {
		w.WriteHeader(http.StatusMethodNotAllowed)
		fmt.Fprintln(w, "Ошибка: метод не разрешен. Используйте DELETE для удаления сообщения")
...
func showMessages(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodGet {
		w.WriteHeader(http.StatusMethodNotAllowed)
		fmt.Fprintln(w, "Ошибка: метод не разрешен. Используйте GET для получения списка сообщений")
...
func showMessage(w http.ResponseWriter, r *http.Request) {
	if r.Method != http.MethodGet {
		w.WriteHeader(http.StatusMethodNotAllowed)
		fmt.Fprintln(w, "Ошибка: метод не разрешен. Используйте GET для получения сообщения")
